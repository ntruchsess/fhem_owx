...
#
# $Id: 21_OWSWITCH.pm 3.19 2013-01 - pahenning $
#
########################################################################################
#
...
sub OWSWITCH_Define ($$) {
  ...
  #-- correct the list of attributes
  if( ($model eq "DS2413") || ($model eq "DS2406") ){
      my $n=index($modules{$hash->{TYPE}}{AttrList},$owg_fixed[2]."Name");
      $modules{$hash->{TYPE}}{AttrList}=substr($modules{$hash->{TYPE}}{AttrList},0,$n);
      @owg_fixed = ("A","B");
  }
